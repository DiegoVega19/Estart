            ...
            <div class="col-md-12">
                    <table class="table table-striped" id="Example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$ent->id}}</td>
                                    <td>{{$ent->nombreEmpleado}}</td>
                                    <td>{{$ent->fechaMarcada}}</td>
                                    <td>{{$ent->horaMarcada}}</td>
                                    <td>
                                        <div class="btn-group">
...
$(document).ready(function(){
    ...
    $(".btn-view").on("click", function(){
        ...
        //alert(cliente);
        var infoEnt = entradas.split("*");
        html = "<p><strong>ID:</strong>"+infoEnt[0]+"</p>"
        html += "<p><strong>Nombre:</strong>"+infoEnt[1]+"</p>"
        html += "<p><strong>Fecha:</strong>"+infoEnt[2]+"</p>"
        html += "<p><strong>Hora:</strong>"+infoEnt[3]+"</p>"
